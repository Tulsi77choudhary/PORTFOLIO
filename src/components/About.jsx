...
function About() {
  return (
    ...
    <div className="relative min-h-screen w-full text-white overflow-hidden bg-gradient-to-r from-purple-400 via-pink-400 to-red-200">
      ...
      <div className="relative z-20 max-w-screen-2xl mx-auto px-4 md:px-20 py-20 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 mt-12 md:mt-24 space-y-4 order-2 md:order-1">
          <span className="text-gray-100 text-lg">Welcome To My Feed</span>
          ...
          <p className="text-sm md:text-md text-justify text-gray-100 mt-4">
          ...
          <div className="flex flex-col md:flex-row justify-between space-y-6 md:space-y-0 items-start md:items-center mt-6">
            ...
            <div className="space-y-2 mt-6 md:mt-0">
              ...
              <ul className="flex space-x-5 mt-2">
                <li><SiSpringboot className="text-xl md:text-2xl hover:scale-110 duration-200 rounded-full" /></li>
                <li><FaReact className="text-xl md:text-2xl hover:scale-110 duration-200 rounded-full" /></li>
                <li><SiMongodb className="text-xl md:text-2xl hover:scale-110 duration-200 rounded-full" /></li>
                <li><GrMysql className="text-xl md:text-2xl hover:scale-110 duration-200 rounded-full" /></li>
              </ul>
            </div>
